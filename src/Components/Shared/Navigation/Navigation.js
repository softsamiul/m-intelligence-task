    ...
    return (
      ...
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          <img className='brand-logo-img' src={BrandLogo} alt='Unified Analytics Logo' />
          <Typography
            variant="h6"
            noWrap
            component="div"
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
            <Box className='menu-item-wrapper'>
                <img className='menu-item-icon' src={AnswerQueryImg} alt='Answer Engine icon' />
                <Button className='menu-item-custom' sx={{ my: 2, color: 'white', display: 'block' }}>
                    Answer Engine
                </Button>
            </Box>
            <Box className='menu-item-wrapper dashboard-wrap'>
                <img className='menu-item-icon' src={DashBoardIcon} alt='DashBoard Icon' />
                <Button sx={{ my: 2, color: 'white', display: 'block' }}>
                    Dashboard
                </Button>
            </Box>
            <Box className='menu-item-wrapper'>
                <img className='menu-item-icon' src={AnswerQueryImg} alt='Anomalies Icon' />
                <Button sx={{ my: 2, color: 'white', display: 'block' }}>
                    Anomalies
                </Button>
            </Box>
          ...
          <Box sx={{ flexGrow: 0 }} className='navbar-right-section'>
            ...
            <span className='navbar-user-text'>Hello <span className='username-text'>Era</span></span>
